...
export const useInvoiceStore = defineStore('invoice', () => {
  ...
  return { invoices, loading, parseErrors, addInvoice, addInvoicesSkipDuplicates, removeInvoice, updateCategory, updateInvoice, clearInvoices, addParseErrors, removeParseError, clearParseErrors, addManualInvoice }
})
