...
fn test_extract_cities_from_real_tickets() {
    let test_cases = vec![
        ("【飞猪】成都-长沙 机票", "../data/原始发票/【飞猪】成都-长沙  订单9586482810622-机票款凭证 报销凭证.pdf"),
        ("【飞猪】长沙-成都 机票", "../data/原始发票/【飞猪】长沙-成都  订单9640359113622-机票款凭证 报销凭证.pdf"),
        ("火车票", "../data/发票与行程单/25429165818005131893.pdf"),
    ];
